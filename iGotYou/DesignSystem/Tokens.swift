...
// Colour, radius and spacing tokens for iGotYou.
//
...
// assigned by usage.
//
// The *values* were re-pitched onto Grab's brand palette (Turn 12). iGotYou is a
...
extension View {
    ...
    func igyShadow(_ s: IGY.Shadow?) -> some View {
