...
extension Font {
    ...
    static func jakarta(_ weight: Int, _ size: CGFloat,
        ...
        let name: String
        switch weight {
        case ...400: name = IGY.FontName.regular
        case 401...500: name = IGY.FontName.medium
        case 501...600: name = IGY.FontName.semibold
        case 601...700: name = IGY.FontName.bold
        default: name = IGY.FontName.extrabold
        }
    ...
    static func mono(_ size: CGFloat, medium: Bool = false,
        ...
        .custom(medium ? IGY.FontName.monoMedium : IGY.FontName.mono,
...
extension IGY {
    struct TextRole {
        ...
        /// 700 20 / −0.4 — Send and Credit & bills (the shorter cards)
...
extension View {
    func textRole(_ role: IGY.TextRole) -> some View {
        font(role.font).tracking(role.tracking)
    }
}

extension Text {
    func textRole(_ role: IGY.TextRole, _ color: Color = IGY.C.ink) -> some View {
