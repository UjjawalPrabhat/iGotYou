...
// than it sounds: the copy *is* the design in several places — "What can iRob
...
enum Mock {
    ...
    static let greetingAsk   = "What can iRob help with?"
    ...
    static let searchables: [SearchEntry] = recentSearches + [
        ...
        SearchEntry(term: "Rewards",         context: "2,480 points",           kind: .service(.rewards)),
    ...
    static let walletLabel   = "IROB WALLET"
